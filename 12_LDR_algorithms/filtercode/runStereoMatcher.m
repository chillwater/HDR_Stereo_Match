...
%for testimage = 1:4
testimage=99;
maxdisp=double(disparity_max);
    example_referenceForCVPR11(maxdisp,testimage,r,eps,thresColor,thresGrad,gamma,threshBorder,gamma_c,gamma_d,r_median,UseParallelToolbox);
%end