A = xlsread('bar_graph_input_Reindeer_including_2exp_hdr_results_table(RMS).xlsx')  %change this which is the input file name before using
BarTitle='Reindeer-Illum1'; 
 FileName='Reindeer_Illum1_RMS';
 %A = xlsread('bar_graph_input_Wood1_including_2exp_hdr_results_table(RMS).xlsx')  %change this which is the input file name before using
 %BarTitle='Wood1-Illum2'; 
 %FileName='Wood1_Illum2_RMS';
Labels = {'CostFilter','SemiGlob','SSMP'}; 
 ...
 %}
  set(gca, 'FontSize', 9)% Sets tick labels back on the Axis
  %{
