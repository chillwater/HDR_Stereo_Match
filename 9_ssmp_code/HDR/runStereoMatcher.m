...
addpath 'algorithms'    %remember to include this directory manually
...
%mkdir('./results/Midd2/Illum2');
for value = 45:45    %change this to see which stereo pairs to be used

%===============
BaseName1='view1_slice_';
BaseName2='view5_slice_';
%===============
    view1_file_name = strcat('view1_slice_',  num2str(value),'.hdr')
    view5_file_name = strcat('view5_slice_',  num2str(value),'.hdr')
%============================================================================



%% Img name, search range and scaling parameter
only_name = strcat('disparity_',num2str(value));
% only_name = 'Art_Matlab_Normalized_slice_62_disparity';
numDisp = 215.0; %===============================================================change this before using, must be max disparity value from ground truth====
%numDisp = 16; % Maximum disparity range (16 for tsukuba, 20 for venus and 60 for teddy and cones)
scale = 1; %scaling parameter (16 for tsukuba, 8 for venus and 4 for teddy and cones)
%%
img_name_l = view1_file_name;
img_name_r = view5_file_name;
% img_name_l = 'view1_slice_62.hdr';
% img_name_r = 'view5_slice_62.hdr';
% img_name_l = ['./img_stereo/' only_name '_left.ppm'];
% img_name_r = ['./img_stereo/' only_name '_right.ppm'];
%result_name_l = ['./Cloth3/Illum3/' only_name '_l.png'];
%result_name_r = ['./Cloth3/Illum3/' only_name '_r.png'];
%result_name_final_l = ['./Cloth3/Illum3/' only_name '_l_post.png'];
%result_name_finar_r = ['./Cloth3/Illum3/' only_name '_r_post.png'];
result_name_l = [ only_name '_l.png'];
result_name_r = [ only_name '_r.png'];
result_name_final_l = [ only_name '_l_post.png'];
result_name_finar_r = [ only_name '_r_post.png'];
%% Parameters
...
%% input image
img_l = double(hdrread(img_name_l));
img_r = double(hdrread(img_name_r));
