...
try
    ...
    if isfield(meta, 'DigitalCamera')
		...
		error(message('images:makehdr:exifFormat', filename, 'Use the ''ExposureValues'' or ''RelativeExposure'' parameter to provide exposure information.'));
...
if (~isequal(meta.ColorType, 'truecolor'))
    error(message('images:makehdr:notRGB'))
end
