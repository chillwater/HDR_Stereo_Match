function example_referenceForCVPR11(maxdisp, testimage,r,eps,thresColor,thresGrad,gamma,threshBorder,gamma_c,gamma_d,r_median,UseParallelToolbox)
...
elseif (testimage==4)
    ...
    Il = double(imread('.\view1.png')) / 255;
    Ir = double(imread('.\view5.png')) / 255;
    numDisp = maxdisp % Maximum disparity range    
...
imwrite(uint8(final_labels), 'disparity.png');
