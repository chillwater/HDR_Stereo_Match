...
%testimage = ;
for value = 45:45
%for value = 15:15  %for single hdr
%for value = 5566:5566
   testimage = value;
       st=clock;
       i=4
    example_referenceForCVPR11(uint8(i),value,testimage,r,eps,thresColor,thresGrad,gamma,threshBorder,gamma_c,gamma_d,r_median,UseParallelToolbox);
